...
checkRole(['learner']);
 ?>
  ...
  <div class="row">
    ...
    <div class="col-md-9 position-relative end-2 my-4">
      <h2>All Courses</h2>
      <div class="row">
        <?php
        // Database connection
        ...
        ?>
          <div class="col-md-4">
            <div class="card mb-4">
              <a href="../course/course_overview.php?id=<?php echo htmlspecialchars($course['id']); ?>">
              ...
              <div class="card-body">
                <h4 class="mb-2 text-deco text-truncate-line-2">
                  <a href="../course/course_overview.php?id=<?php echo htmlspecialchars($course['id']); ?>" class="text-inherit text-decoration-none text-dark">
                ...
                <div class="row align-items-center g-0">
                  ...
                  <div class="col-auto">
                    ...
                    <?php else: ?>
                      <a href="../course/course_overview.php?id=<?php echo htmlspecialchars($course['id']); ?>" class="btn btn-primary">Enroll Now</a>
                    <?php endif; ?>
                  </div>
                </div>
              </div>
