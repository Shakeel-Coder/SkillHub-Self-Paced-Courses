...
<div class="sidebar" id="sidebar">
    ...
    <a href="admin_dashboard.php" class="tab-link" onclick="setActiveTab(this)"><i class="bi bi-house"></i><span>Dashboard</span></a>
    <a href="manage_courses.php" class="tab-link" onclick="setActiveTab(this)"><i class="bi bi-book"></i><span>Manage Courses</span></a>
    <a href="manage_users.php" class="tab-link" onclick="setActiveTab(this)"><i class="bi bi-people"></i><span>Manage Users</span></a>
</div>
